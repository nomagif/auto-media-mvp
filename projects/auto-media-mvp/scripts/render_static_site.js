...
<body>
  <div class="wrap">
    <div class="hero">
      ...
      <p class="meta">Public layer: open observatory. Next layer: premium dataset access, historical exports, and custom monitoring.</p>
    </div>
    <div class="nav">
...
${body}
    ...
    <div class="footer">Generated from <code>output/rankings</code> via the minimal static renderer. This surface is intended to show metrics and observed changes, not narrative analysis. For premium data access or custom monitoring, add a contact / sales CTA in the next iteration.</div>
  </div>
</body>
</html>
`;
