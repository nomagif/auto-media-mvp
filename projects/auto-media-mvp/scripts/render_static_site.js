...
<body>
  <div class="wrap">
    <div class="hero">
      ...
      <p class="meta">Public layer: open observatory. Next layer: premium dataset access, historical exports, and automated premium feeds.</p>
    </div>
    <div class="nav">
...
${body}
    ...
    <div class="footer">Generated from <code>output/rankings</code> via the minimal static renderer. This surface is intended to show metrics and observed changes, not narrative analysis. Premium monetization should stay automation-first: dataset access, historical exports, packaged feeds, and later API access.</div>
  </div>
</body>
</html>
`;
